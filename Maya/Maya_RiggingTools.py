...
#       import Proxi_Rigging
#       reload(Proxi_Rigging)
...
def createGUI():
    ...
    ccWin = cmds.window(winName, title = 'Proxi Rigging v0.1', resizeToFitChildren = 1,  sizeable = 0)
    ...
    cmds.symbolButton(image = 'rigging_icons/ccButton09.PNG', command = mz_ccButtonSnap09)
    cmds.symbolButton(image = 'rigging_icons/ccButton01.PNG', command = snapCircle)
    cmds.symbolButton(image = 'rigging_icons/ccButton23.PNG', command = mz_ccButtonSnap23)
    cmds.symbolButton(image = 'rigging_icons/ccButton14.PNG', command = mz_ccButtonSnap14)
    cmds.symbolButton(image = 'rigging_icons/ccButton10.PNG', command = mz_ccButtonSnap10)
    cmds.button(label="Square", command=snapSquare)
    cmds.symbolButton(image = 'rigging_icons/ccButton02.PNG', command = snapCube)
    cmds.button(label="Triangle", command=snapTriangle)
    cmds.button(label="Pyramid")
    cmds.button(label="Cone")
    cmds.symbolButton(image = 'rigging_icons/ccButton03.PNG', command = snapSpearTip)
    cmds.symbolButton(image = 'rigging_icons/ccButton26.PNG', command = mz_ccButtonSnap26)
    cmds.button(label="Rombus")
    cmds.symbolButton(image = 'rigging_icons/ccButton35.PNG', command = mz_ccButtonSnap35)
    cmds.symbolButton(image = 'rigging_icons/ccButton04.PNG', command = snapArrowDouble)
    cmds.button(label="90 arrow")
    cmds.button(label="180 arrow")
    cmds.symbolButton(image = 'rigging_icons/ccButton27.PNG', command = mz_ccButtonSnap27)
    cmds.symbolButton(image = 'rigging_icons/ccButton05.PNG', command = snapRotateArrow)
    cmds.symbolButton(image = 'rigging_icons/ccButton06.PNG', command = snapArrowDoubleThin)
    cmds.symbolButton(image = 'rigging_icons/ccButton07.PNG', command = mz_ccButtonSnap07)
    cmds.button(label="Cross")
    cmds.button(label="Quad arrow")
    cmds.button(label="Octo arrow")
    cmds.symbolButton(image = 'rigging_icons/ccButton38.PNG', command = mz_ccButtonSnap38)
    cmds.symbolButton(image = 'rigging_icons/ccButton16.PNG', command = mz_ccButtonSnap16)
    cmds.symbolButton(image = 'rigging_icons/ccButton15.PNG', command = mz_ccButtonSnap15)
    cmds.symbolButton(image = 'rigging_icons/ccButton08.PNG', command = mz_ccButtonSnap08)
    cmds.symbolButton(image = 'rigging_icons/ccButton28.PNG', command = mz_ccButtonSnap28)
    cmds.symbolButton(image = 'rigging_icons/ccButton29.PNG', command = mz_ccButtonSnap29)
    cmds.symbolButton(image = 'rigging_icons/ccButton30.PNG', command = mz_ccButtonSnap30)
    cmds.symbolButton(image = 'rigging_icons/ccButton31.PNG', command = mz_ccButtonSnap31)
    cmds.symbolButton(image = 'rigging_icons/ccButton32.PNG', command = mz_ccButtonSnap32)
    cmds.symbolButton(image = 'rigging_icons/ccButton34.PNG', command = mz_ccButtonSnap34)
    cmds.symbolButton(image = 'rigging_icons/ccButton39.PNG', command = mz_ccButtonSnap39)
    cmds.button(label="Cog")
    cmds.button(label="Spiral")
    cmds.symbolButton(image = 'rigging_icons/ccButton41.PNG', command = mz_ccButtonSnap41)
    cmds.symbolButton(image = 'rigging_icons/ccButton42.PNG', command = mz_ccButtonSnap42)
    cmds.symbolButton(image = 'rigging_icons/ccButton43.PNG', command = mz_ccButtonSnap43)
    cmds.symbolButton(image = 'rigging_icons/ccButton40.PNG', command = mz_ccButtonSnap40)
    cmds.symbolButton(image = 'rigging_icons/ccButton19.PNG', command = mz_ccButtonSnap19)
    cmds.symbolButton(image = 'rigging_icons/ccButton20.PNG', command = mz_ccButtonSnap20)
    cmds.symbolButton(image = 'rigging_icons/ccButton21.PNG', command = mz_ccButtonSnap21)
    cmds.symbolButton(image = 'rigging_icons/ccButton22.PNG', command = mz_ccButtonSnap22)
    cmds.button(label="Bulb")
    cmds.setParent(controllersLayout)
    cmds.frameLayout(label = 'Character specific', collapsable=True, collapse=False, height=107)
    cmds.scrollLayout(childResizable = 1)
    cmds.gridLayout(numberOfColumns = 8, cellWidthHeight = (40, 40), width = 100)
    cmds.symbolButton(image = 'rigging_icons/ccButton44.PNG', command = mz_ccButtonSnap44)
    cmds.symbolButton(image = 'rigging_icons/ccButton45.PNG', command = mz_ccButtonSnap45)
    cmds.symbolButton(image = 'rigging_icons/ccButton36.PNG', command = mz_ccButtonSnap36)
    cmds.symbolButton(image = 'rigging_icons/ccButton37.PNG', command = mz_ccButtonSnap37)
    cmds.symbolButton(image = 'rigging_icons/ccButton11.PNG', command = mz_ccButtonSnap11)
    cmds.symbolButton(image = 'rigging_icons/ccButton12.PNG', command = mz_ccButtonSnap12)
    cmds.symbolButton(image = 'rigging_icons/ccButton24.PNG', command = mz_ccButtonSnap24)
    cmds.symbolButton(image = 'rigging_icons/ccButton25.PNG', command = mz_ccButtonSnap25)
    cmds.symbolButton(image = 'rigging_icons/ccButton33.PNG', command = mz_ccButtonSnap33)
...
def shapeArrowDouble(self):
    ...
    cmds.setAttr(arrow + '.sx', 0.75)
    cmds.setAttr(arrow + '.sy', 0.75)
...
#snapArrowDouble
def snapArrowDouble(self):
    #the selected object(s)
    selObj = cmds.ls(selection = 1)
    
    #if no object is selected, create the ctrl at the center of the scene
    if len(selObj) == 0:
        shapeArrowDouble(self)
...
#snapRotateArrow
def snapRotateArrow(self):
    #the selected object(s)
    selObj = cmds.ls(selection = 1)
    
    #if no object is selected, create the ctrl at the center of the scene
    if len(selObj) == 0:
        shapeRotateArrow(self)
...
#snapArrowDoubleThin
def snapArrowDoubleThin(self):
    #the selected object(s)
    selObj = cmds.ls(selection = 1)
    
    #if no object is selected, create the ctrl at the center of the scene
    if len(selObj) == 0:
        shapeArrowDoubleThin(self)
